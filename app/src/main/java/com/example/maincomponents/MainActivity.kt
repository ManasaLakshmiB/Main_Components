...
//import kotlinx.android.synthetic.main.activity_main.lvdisplay
...
//            loadContacts()
    ...
    private fun loadContacts() {
        if (ActivityCompat.checkSelfPermission(
            ...
            val display = findViewById<ListView>(R.id.lvdisplay)
            Log.d("Contacts", contacts.joinToString(separator = "\n"))
            //using cursor add all the contacts from our contact list

            var cursor:Cursor?= contentResolver.query(ContactsContract.CommonDataKinds.Phone.CONTENT_URI, null,null,null,null)
            startManagingCursor(cursor)

            //stored    display name,phone number and id in array

            var array = arrayOf(ContactsContract.CommonDataKinds.Phone.DISPLAY_NAME,ContactsContract.CommonDataKinds.Phone.NUMBER,
                ContactsContract.CommonDataKinds.Phone._ID)
           //stored id's of UI components
            var to= intArrayOf(android.R.id.text1,android.R.id.text2)
          //created adapter and passed context,what type of list i want to display and passed object of cursor and both the arrays
            var data:SimpleCursorAdapter= SimpleCursorAdapter(this,android.R.layout.simple_list_item_2,cursor,array,to)

           // listview of adapter and object of my adapter
